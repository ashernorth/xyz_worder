...
function swapFunc() {
  ...
  if (x.innerHTML === "") {
    x.innerHTML = "<button style=\"background-color:black; border-color:#88888888; color:black; cursor:pointer;\" onclick=\"changeColor('#88888888'); changeButtonBorderColor('#88888888');\">-</button>";
  } else {
    x.innerHTML = "";
  }
}